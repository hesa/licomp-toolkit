...
test_version()
{
    ...
    test_licomp_tk_text "versions" "| wc -l" "6"
}
...
test_supports_license()
{
    ...
    test_licomp_tk_text " -of text supports-license MIT" " | wc -l" 5
    test_licomp_tk_text " -of json supports-license MIT" " | jq .[] | wc -l" 5
    test_licomp_tk_text " supports-license MIT" " | jq .[] | wc -l" 5
}

test_supports_provisioning()
{
    echo "# supports provisioning"
    test_licomp_tk_text " -of text supports-provisioning binary-distribution" " | wc -l" 5
...
test_supports_usecase()
{
    ...
    test_licomp_tk_text " -of text supports-usecase library" " | wc -l " 3
}
